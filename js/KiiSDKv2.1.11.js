  ...
  KiiRequest.prototype.execute = function(callbacks, ignoreBody) {
    ...
    callbacks = {
      onComplete: (function(_this) {
        return function() {
          var e, errString, error, json, ref, responseHeaders, xhr;
...
root.KiiUser = (function() {
  ...
  KiiUser.prototype._updateUsingCallbacks = function(identityData, callbacks, userFields, removeFields) {
    var country, data, errorString, hasIdentityData, hasRemoveFields, hasUserFields, j, key, len, removeField, value;
...
root.KiiSocialConnectNetwork = (function() {
  ...
  function KiiSocialConnectNetwork(_network) {
    ...
    this._getCallbacks = bind(this._getCallbacks, this);
    ...
    this._getExtras = bind(this._getExtras, this);
    this._setExtras = bind(this._setExtras, this);
    this._getSecret = bind(this._getSecret, this);
    this._setSecret = bind(this._setSecret, this);
    this._getKey = bind(this._getKey, this);
    this._setKey = bind(this._setKey, this);
